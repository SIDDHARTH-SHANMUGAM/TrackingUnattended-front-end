...
function Navbar() {
  ...
  if(showMenu)
  {
    menuicon = <img src='/cross.svg' alt='' onClick={()=> setShowMenu(!showMenu)} />
    menu= <Menu>
        <Div>
            <MenuBar>
                {menuicon}
  ...
  {
    menuicon = <img src='/menubar.svg' alt='' onClick={()=> setShowMenu(!showMenu)} />
  }
